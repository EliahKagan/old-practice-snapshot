...
namespace {
    ...
    void test_decrease()
    {
        PrimHeapMultiSet<std::string> heap;
        ...
        heap.push("bar");
        heap.push("baz");
        heap.decrease("quux", "abracadabra");
        heap.decrease("zilch", "bar");
        heap.decrease("bar", "aardvark");
    ...
    void test_maxheap()
    {
        PrimHeapMultiSet<double, std::greater> heap;
        ...
        heap.push(1.9);
        heap.push(2.0);
        heap.decrease(1.2, 2.5);
        heap.decrease(1.7, 2.8);
        heap.decrease(2.0, 3.0);
        heap.decrease(1.4, 1.9);
        heap.decrease(1.4, 1.9);
        heap.decrease(1.4, 3.0);
