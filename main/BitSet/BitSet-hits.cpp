...
namespace {
    ...
    private:
        ...
        std::vector<std::uint64_t> bits_; mutable int hits {0};
    };
...
int main()
{
    constexpr std::size_t range {1'000'000u}, step {3000u};
    ...
    for (const auto k : a) std::printf("%zu ", k);
    std::putchar('\n');
}
