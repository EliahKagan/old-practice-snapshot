...
internal static class Solution {
    ...
    private static IList<int> CountPairs(this IList<int> sizes)
    {
        var sum = sizes.Sum();
        return sizes.Select(size => size * (sum -= size)).ToList();
    }

    private static IEnumerable<int> CountTriplets(this IList<int> sizes)
    {
    ...
    private static void Main()
    {
        ...
        Console.WriteLine(sizes.ToList().CountTriplets().Sum() % Mod);
    }
}
