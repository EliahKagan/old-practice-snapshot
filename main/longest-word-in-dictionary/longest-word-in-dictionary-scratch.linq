...
private static void Main() {
    var s = new Solution();
    s.LongestWord("w","wo","wor","worl", "world").Dump("first");
    s.LongestWord("a", "banana", "app", "appl", "ap", "apply", "apple").Dump("second");
    s.LongestWord("foo", "bar", "baz", "ba", "fo").Dump("third");
    s.LongestWord("foo", "bar", "f", "baz", "ba", "fo").Dump("fourth");
}
