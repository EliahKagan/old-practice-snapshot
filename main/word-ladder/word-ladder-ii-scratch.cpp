...
namespace {
    ...
    void test(const string src, const string dest, vector<string> words)
    {
        Solution s;
        print(s.findLadders(src, dest, words));
    }
}
...
int main()
{
    ...
    test("hit"s, "cag"s,
         {"hot", "dot", "dog", "lot", "log", "cag"});

    test("abcde"s, "zzzzz"s,
         {"zbcde", "zzzzz", "azcde", "abzde", "zbcdz", "zdcdz", "zbzdz", "zdzdz", "zzzdz"});
