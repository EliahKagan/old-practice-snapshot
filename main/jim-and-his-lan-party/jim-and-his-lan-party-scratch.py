...
class DisjointPlayerSets:
    def __init__(self, player_games, game_count):
        ...
        # FIXME: this is the bug: need game, pop_target -- not pop_target, game
        for pop_target, game in enumerate(self._pop_targets_or_start_times):
            if pop_target == -1:
    ...
    def _union(self, player1, player2):
        '''Unites sublans and returns (parent, child), or (None, None) .'''
        '''
...
with open(r'C:\Users\ek\source\input06.txt', 'r') as f:
    def read_record():
