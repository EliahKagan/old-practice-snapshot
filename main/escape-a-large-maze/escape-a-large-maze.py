...
class Solution:
    def isEscapePossible(self, blocked: List[List[int]],
        ...
        while (source_fringe and target_fringe and
                (source_area < max_enclosure or target_area < max_enclosure)):
            ...
            for nei in neighbors(*target_fringe.pop()):
                try:
                    ...
                    vis[nei] = State.TARGET
                    target_area += 1
                    target_fringe.append(nei)

        # print(source_area, target_area, max_enclosure)
        # print(len(source_fringe), len(target_fringe))
        return not (source_area < max_enclosure or target_area < max_enclosure)
