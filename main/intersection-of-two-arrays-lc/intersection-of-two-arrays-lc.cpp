class Solution {
public:
    static vector<int> intersection(const vector<int>& a,
                                    const vector<int>& b);
...
vector<int> Solution::intersection(const vector<int>& a, const vector<int>& b)
{
    vector<int> ret;
...
void Solution::intersect(const vector<int>& a, const vector<int>& b,
                         back_insert_iterator<vector<int>> it)
{
    unordered_set<int> xs (cbegin(a), cend(a));
