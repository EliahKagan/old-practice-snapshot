...
public class ArrayEx { // fake ArrayEx class, for troublemaking purposes
    internal static int[,] Mul(int[,] fake_self, int[,] fake_other)
    {
        throw new NotImplementedException(message: "will never be implemented");
    }
}
