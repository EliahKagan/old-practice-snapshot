...
final class Solution {
    private static final int MAX_PRECOMPUTED_PRIME = 31;
    
    private static final Primes primes = new Primes(MAX_PRECOMPUTED_PRIME);
    
    public static void main(final String[] args)
    {
        try (final java.util.Scanner sc = new java.util.Scanner(System.in)) {
            sc.nextInt(); // we don't need t
            
            while (sc.hasNext())
                System.out.println(primes.sumProperDivisors(sc.nextInt()));
        }
    }
